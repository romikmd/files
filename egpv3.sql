...
--
-- Хост: localhost
-- Время создания: Мар 10 2023 г., 02:45
...
(1, 1, 'cs', 'Обычный', 10, 32, 27016, 27116, 'Новый игровой сервер', 'eyJyZWhsZHMiOiJSZUhMRFMgMy43LjAueHh4LWRldiJ9', '/path/cs/', '/servers/', '/path/update/cs/', '500:1000', '', '', 0, '30:90:180', '30:90:180', 0, 0, 1, 'de_dust2x2', 1, 1, 1, 1, 1, 1, '', 5000, 0, '0.25:0.35', '', '', 1, 1),
...
(1, 'SRV-1', 'ipaddres:22', 'rootpass', 'ftp', 'ftppasswd', 3306, 'ftp', 1, 1, 1, 1, 0, 0, 0, 0, 2000, 10, 1, 1, 'game.online', 0);
...
(1, 'admin', 'ENGINEGPHASH', 'Admin', '', '', 'game@mail.ru', '', '', '', 1, '', 961.2, '', 'admin', '', 1, '179.196.3.99', 'Google Chrome', 1678405499, 1511843974, 0, 0, 0, 0, 1, 1, 0, '0', '0');
